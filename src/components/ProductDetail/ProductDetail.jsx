...
export default function ProductDetail({ navbarRefresh, setNavbarRefresh }) {
        ...
        <div className="pt-6">
          ...
          <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
            ...
            <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
              {products.product_list_image?.length > 2
                ? products.product_list_image.map((product) => (
                    <>
          ...
          <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
            ...
            <div className="mt-4 lg:mt-0 lg:row-span-3">
              ...
              <form className="mt-10">
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-3">
                      {products.product_color?.map((color, index) => (
                        <RadioGroup.Option
                          key={index}
                          value={color}
                          className={classNames(
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                      {products.product_size?.map((size, index) => (
                        <RadioGroup.Option
                          key={index}
                          value={size}
                          onClick={(e) => handleSelectedSize(e, size)}
                ...
                <div
                  onClick={(e) => buyNow(e, products._id)}
